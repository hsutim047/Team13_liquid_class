...
rt = shapes.rectangle(pos=(0,0), width=5, height=5)
...
while (t < 300):
    ...
    for ball in Balls:
        for ball2 in Balls:
            ...
            elif ball.cc_distance(ball2) < ball.r + ball2.r and mag(ball.tempos - ball2.tempos) > mag(ball.tempos + ball.v * dt - ball2.tempos - ball2.v * dt):
